module.exports = {
  ...
  collectCoverageFrom: [
    ...
    "!./common/ErrorBoundary/*.{js,jsx,ts,tsx}",
    "!./common/T/stories/*.{js,jsx,ts,tsx}",
    "./containers/**/*.{js,jsx,ts,tsx}",
    "!./containers/TrackDetailsContainer/*.{js,jsx,ts,tsx}",
    "./features/**/*.{js,jsx,ts,tsx}",
    "!./features/itunes/api/*.{js,jsx,ts,tsx}",
    "!./features/trackDetails/api/*.{js,jsx,ts,tsx}",
    "!./pages/**/*.{js,jsx,ts,tsx}",
    "./store/**/*.{js,jsx,ts,tsx}",
